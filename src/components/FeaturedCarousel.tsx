      ...
      <Link to={`/recipe/${recipe.slug}`} className="group block">
        <Card className="overflow-hidden border card-shadow hover:card-hover-shadow transition-smooth">
          <div className="flex flex-col sm:flex-row h-[350px] sm:h-[280px]">
            ...
            <div className="flex-1 sm:w-2/3 flex flex-col items-center justify-center px-8 py-6 text-center order-2 sm:order-1">
            ...
            <div className="sm:w-1/3 h-40 sm:h-full overflow-hidden order-1 sm:order-2">
              <img
                src={recipe.image}
                alt={recipe.title}
